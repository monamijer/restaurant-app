$(document).ready(function () {
    ...
    $('#recherche-client').on('keyup', function () {
        ...
        timeout = setTimeout(function () {
            $.get('/admin/clients/rechercher-ajax', { q: terme }, function (clients) {
                let html = '';
                clients.forEach(function (c) {
                    html += `
                        <tr>
                            ...
                            <td><strong>${Number(c.total_depense || 0).toLocaleString('fr-FR')} BIF</strong></td>
        ...
        }, 300); // debounce : évite une requête à chaque frappe
    });
});